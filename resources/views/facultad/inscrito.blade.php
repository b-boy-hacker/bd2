...
@section('title', 'Estudiantes Inscritos por Facultad')
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Gráfico de Inscritos por Facultad</h3>
        </div>
        <div class="card-body">
            <div id="chartdiv"></div>
        </div>
                ...
                <tbody>
                    @forelse ($facultades as $facultad)
                        <tr>
                            ...
                            <td>{{ $facultad->total_inscritos }}</td>
                        </tr>
                    @empty
                        <tr>
