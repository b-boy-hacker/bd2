...
@section('title', 'Carreras Inscritas')
    ...
    <script>
        am5.ready(function() {
            ...
            var xAxis = chart.xAxes.push(am5xy.CategoryAxis.new(root, {
                maxDeviation: 0.3,
                categoryField: "carrera",  // Campo para las categorías (carreras)
                renderer: xRenderer,
            ...
            var series = chart.series.push(am5xy.ColumnSeries.new(root, {
                ...
                categoryXField: "carrera",  // Campo de categorías (carreras)
                tooltip: am5.Tooltip.new(root, {
            ...
            var data = @json($data);  // Los datos ya están transformados usando map
